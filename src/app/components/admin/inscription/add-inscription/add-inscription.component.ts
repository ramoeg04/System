...
export class AddInscriptionComponent implements OnInit {
  ...
  constructor(private toastr: ToastrService, public dialogRef: MatDialogRef<AddInscriptionComponent>, private servicesSystem: ServicesSystemService, @Inject(MAT_DIALOG_DATA) public data: any) { }
